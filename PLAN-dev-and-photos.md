...
**Хранение фото (среднее фото ~4 МБ JPEG):**

| | За ретрит | За год | Накопительно 3 года |
|---|---|---|---|
| Оригиналы (700 × 4 МБ) | 2.8 ГБ | 28 ГБ | 84 ГБ |
| Thumbnails (700 × 0.2 МБ) | 0.14 ГБ | 1.4 ГБ | 4.2 ГБ |
| **Итого** | **~3 ГБ** | **~30 ГБ** | **~88 ГБ** |

**Варианты хранения:**

| Сервис | Бесплатно | Цена за 30 ГБ/год |
|--------|-----------|-------------------|
| Supabase Storage (Pro $25/мес) | 100 ГБ | Входит в план |
| Cloudflare R2 | 10 ГБ | ~$0.45/мес, **без платы за скачивание** |
| AWS S3 | 5 ГБ (12 мес) | ~$0.70/мес |
...
| Хранение (R2 или Supabase Pro) | $0–8 |
...
6. **Хранение** — Cloudflare R2 (дешевле, без egress) или Supabase Storage (Pro)?
7. **Срок хранения** — сколько лет хранить фото? (для расчёта накопленного объёма)
